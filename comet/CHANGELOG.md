...
## v1.12.1
### Added
* Add mount for /etc/machine-id for servers for Hytale ([#292](https://github.com/Sudo-Ivan/Nebulodactyl/comet/pull/292))
...
* [CVE-2026-21696](https://github.com/Sudo-Ivan/Nebulodactyl/comet/security/advisories/GHSA-2497-gp99-2m74)
...
* User-defined labels not being passed to environment ([#191](https://github.com/Sudo-Ivan/Nebulodactyl/comet/pulls/191))
* Fixes handling of termination signals for containers ([#192](https://github.com/Sudo-Ivan/Nebulodactyl/comet/pulls/192))
* Fixes logic to use base2 (1024, *bibyte) when calculating memory limits ([#190](https://github.com/Sudo-Ivan/Nebulodactyl/comet/pulls/190))
* Fixes hard-links being counted multiple times when calculating disk usage ([#181](https://github.com/Sudo-Ivan/Nebulodactyl/comet/pulls/181))

### Added
* Support relative file paths for the Wings config ([#180](https://github.com/Sudo-Ivan/Nebulodactyl/comet/pull/180))
* Support mounting generated `/etc/passwd` files to containers ([#197](https://github.com/Sudo-Ivan/Nebulodactyl/comet/pulls/197))
...
## v1.11.12
### Fixed
* Arbitrary File Write/Read ([GHSA-gqmf-jqgv-v8fw](https://github.com/Sudo-Ivan/Nebulodactyl/comet/security/advisories/GHSA-gqmf-jqgv-v8fw))
* Server-side Request Forgery (SSRF) during remote file pull ([GHSA-qq22-jj8x-4wwv](https://github.com/Sudo-Ivan/Nebulodactyl/comet/security/advisories/GHSA-qq22-jj8x-4wwv))
* Invalid `Content-Type` being used with the `wings diagnostics` command ([#186](https://github.com/Sudo-Ivan/Nebulodactyl/comet/pull/186))
...
## v1.11.5
### Added
* Added a config option to disable Wings config.yml updates from the Panel (https://github.com/Sudo-Ivan/Nebulodactyl/comet/commit/ec6d6d83ea3eb14995c24f001233e85b37ffb87b)

### Changed
* Wings is now built with Go 1.19.7

### Fixed
* Fixed archives containing partially matched file names (https://github.com/Sudo-Ivan/Nebulodactyl/comet/commit/43b3496f0001cec231c80af1f9a9b3417d04e8d4)
