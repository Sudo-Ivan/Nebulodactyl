...
func RequireAuthorization() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// All requests to Comet must be authorized with the authentication token present in
		// the Comet configuration file. Remeber, all requests to Comet come from the Panel
