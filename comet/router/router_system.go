...
import (
	...
	"github.com/Sudo-Ivan/Nebulodactyl/comet/server/installer"
	"github.com/Sudo-Ivan/Nebulodactyl/comet/system"
)

// Returns information about the system that comet is running on.
...
// Creates a new server on the comet daemon and begins the installation process
// for it.
...
// Updates the running configuration for this Comet instance.
