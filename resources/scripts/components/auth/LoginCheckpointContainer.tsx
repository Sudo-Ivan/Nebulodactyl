    ...
    return (
        <LoginFormContainer className={`w-full flex flex-col`}>
            ...
            <div className='flex w-full flex-col gap-3 sm:flex-row sm:justify-between sm:items-center'>
                <Button
                    className={`bg-cream-400 rounded-full p-2 px-4 text-mocha-500 hover:cursor-pointer hover:bg-cream-300 hover:scale-102 ease-in-out w-full sm:w-auto`}
                    size={'xlarge'}
                    type={'submit'}
                ...
                <button
                    ...
                    className={
                        'block text-center w-full sm:w-auto py-2.5 px-4 text-xs font-medium tracking-wide uppercase text-cream-50 hover:text-cream-50/80 transition-colors duration-200 border border-cream-50/20 rounded-full hover:bg-cream-50/10 focus:outline-none focus:ring-2 focus:ring-cream-50/30'
                    }
                >
