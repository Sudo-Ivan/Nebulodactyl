                        ...
                        <VirtualizedList
                                    ...
                                    <div className='flex-1 min-w-0'>
                                        ...
                                        <div className='flex items-center gap-4 text-xs font-large text-text/20'>
                                            ...
                                            <div className='flex items-center gap-2 hover:cursor-pointer'>
                                                ...
                                                <code className='font-mono px-2 py-1 bg-mocha-400 border border-mocha-200 rounded text-cream-400 flex'>
                            ...
                            emptyState={
                                <div className='text-center py-12'>
                                    ...
                                    <h3 className='text-lg font-medium text-cream-100 mb-2'>No API Keys</h3>
