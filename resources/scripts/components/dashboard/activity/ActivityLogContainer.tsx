            ...
            <div className='w-full h-full min-h-full flex-1 flex flex-col px-2 sm:px-0'>
                        ...
                        <div className='bg-gradient-to-b from-cream-50/3 to-cream-50/2 border-[1px] border-cream-50/7 rounded-xl p-4 hover:border-cream-50/13 transition-all duration-150 shadow-sm'>
                            <div className='flex items-center gap-2 mb-4'>
                                <div className='w-5 h-5 rounded-lg bg-cream-50/7 flex items-center justify-center'>
                                    <Funnel width={22} height={22} className='text-cream-500' fill='currentColor' />
                                </div>
                            ...
                            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
                                ...
                                <div>
                                    ...
                                    <Select
                                        ...
                                        className='w-full px-3 py-2 bg-zinc-800 border border-zinc-600 rounded-lg text-cream-100 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 hover:border-zinc-500 transition-colors duration-150'
                                    >
                ...
                >
                    <div className='bg-gradient-to-b from-cream-50/3 to-cream-50/2 border-[1px] border-cream-50/7 rounded-xl p-4 hover:border-cream-50/13 transition-all duration-150 shadow-sm'>
                        <div className='flex items-center gap-2 mb-4'>
                            <div className='w-5 h-5 rounded-lg bg-cream-50/7 flex items-center justify-center'>
                                <Magnifier width={22} height={22} className=' text-cream-500' fill='currentColor' />
                            </div>
                            <h3 className='text-base font-semibold text-cream-100'>Activity Events</h3>
                            {filteredData?.items && (
