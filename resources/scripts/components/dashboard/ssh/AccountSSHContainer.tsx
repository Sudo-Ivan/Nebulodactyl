                        ...
                        {!data || data.length === 0 ? (
                            <div className='text-center py-12'>
                                <div className='w-16 h-16 mx-auto mb-4 rounded-full bg-cream-50/7 flex items-center justify-center'>
                                    <Key width={22} height={22} className='text-cream-500' fill='currentColor' />
                                </div>
                                <h3 className='text-lg font-medium text-cream-100 mb-2'>No SSH Keys</h3>
                                <p className='text-sm text-cream-500 max-w-sm mx-auto'>
                                    {!data
                                                ...
                                                <div className='flex-1 min-w-0'>
                                                    ...
                                                    <div className='flex items-center gap-4 text-xs text-cream-500'>
                                                        ...
                                                        <div className='flex items-center gap-2'>
                                                            ...
                                                            <code className='flex gap-1 font-mono px-2 py-1 bg-mocha-400 border border-mocha-200 rounded text-cream-400'>
